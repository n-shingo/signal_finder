...
<開始信号>--> |                       |
    ...
    B. 赤信号検出時のアルゴリズム
        ...
        2) 平均画像の各領域の重心を赤信号の中心座標とし,初期赤信号テンプレート画像との相関係数を求める．
    ...
    C. 青信号待ちのアルゴリズム
       ...
       2) 平均画像の各領域の重心を赤信号の中心座標とした位置の画像と，赤信号テンプレート画像(T_r)との相
          関係数を算出する．相関係数が閾値(=0.9)以上の領域があれば，最良の相関係数の領域の画像を新しい
          赤信号テンプレートとして T_r を更新し，1)へ戻って青信号待ちを続ける．
       3) 次に青信号テンプレートと逆行用青信号テンプレートとの相関係数 r1, r2 を求める．r1が閾値(=0.6)
          以上かつr2が閾値(=0.8)以上の場合は，青色画像検出とする．そして，アイドリング状態に遷移する．
